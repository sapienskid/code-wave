      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        >
          <h1 className="text-5xl md:text-8xl font-bold tracking-tight leading-none mb-6">
            <span className="block text-[#d946ef]">
              {siteConfig.name}
            </span>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12 text-sm">
          <div className="flex items-center gap-2 px-6 py-3 border-2 border-[#E6E1F0]/20 backdrop-blur-sm hover:border-[#d946ef]/50 transition-all duration-300">
          ...
          {/* CRITICAL: Cost Tag */}
          <div className="flex items-center gap-2 px-6 py-3 border-2 border-[#d946ef] bg-[#d946ef]/10 backdrop-blur-sm transition-all duration-300">
            <span className="font-bold text-[#d946ef]">Admission: {siteConfig.admission}</span>
          </div>
        </div>
            ...
            {['DAYS', 'HOURS', 'MINUTES', 'SECONDS'].map((unit, index) => {
              ...
              return (
                <div key={unit} className="flex flex-col items-center">
                  <div className="w-16 h-16 md:w-20 md:h-20 border-2 border-[#d946ef]/30 bg-[#d946ef]/10 flex items-center justify-center mb-2">
                    <span className="text-2xl md:text-3xl font-bold text-[#d946ef]">{String(value).padStart(2, '0')}</span>
                  </div>
        ...
        {/* Primary CTA */}
        <a href={siteConfig.registrationLink} className="inline-block group relative px-12 py-5 bg-[#d946ef] text-lg font-semibold hover:scale-105 hover:shadow-lg hover:shadow-[#d946ef]/50 transition-all duration-300">
